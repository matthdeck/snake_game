 ...
 *
 * @param [number, number] cell Coordinates (getRandomFoodPostion) of the cell to return a value for 
 * @param number xLength The number of cells across the x axis (21)
 * @param number yLength The number of cells across the y axis (21)
 * @param [number, number][] snakeOrigin Coordinates of the position of the snake from head to tail. E.g. [[4, 1], [3, 1]] (snakeBody)
 * @param [number, number] point Coordinates of the point. (getSnakeHead)
 *
 * @returns number The value for the cell
 */
export function heuristic(cell, xLength, yLength, snake, point) {
